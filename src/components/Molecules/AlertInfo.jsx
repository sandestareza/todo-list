...
const AlertInfo = () => {
    ...
    return (
        <>
            <div data-cy="alert-info" className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
